...
<script src="${pageContext.request.contextPath}/resources/js/bootstrap.min.js"></script> <!-- Bootstrap -->
<script src="${pageContext.request.contextPath}/resources/js/jquery-1.9.1.js"></script> <!-- JQuery -->
<script src="${pageContext.request.contextPath}/resources/js/supersized.3.2.7.min.js"></script> <!-- Slider -->
<script src="${pageContext.request.contextPath}/resources/js/waypoints.js"></script> <!-- WayPoints -->
<script src="${pageContext.request.contextPath}/resources/js/waypoints-sticky.js"></script> <!-- Waypoints for Header -->
<script src="${pageContext.request.contextPath}/resources/js/jquery.isotope.js"></script> <!-- Isotope Filter -->
<script src="${pageContext.request.contextPath}/resources/js/jquery.fancybox.pack.js"></script> <!-- Fancybox -->
<script src="${pageContext.request.contextPath}/resources/js/jquery.fancybox-media.js"></script> <!-- Fancybox for Media -->
...
<script src="${pageContext.request.contextPath}/resources/js/main.js"></script> <!-- Default JS -->
<!-- End Js -->
